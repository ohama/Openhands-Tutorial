...
- 실제 측정된 LLM 호출 1회 평균은 **35B ≈ 5.3초**(67 TerminalAction / 356초), **122B ≈ 6.3초**(150 TerminalAction / 1229초)입니다. 이 책의 초기 계획 단계에서 한 차례 추정했던 "약 14–32초/사이클"은 사전 예측치였고 실측값과 다르다는 점을 부록 C에서 함께 정정합니다.
